...
package uz.myuzb.biometricfirst;
...
public class GraphicOverlay extends View {
     ...
     * instances to the overlay using {@link uz.myuzb.biometricfirst.GraphicOverlay#add(Graphic)}.
     */
    public abstract static class Graphic {
        private uz.myuzb.biometricfirst.GraphicOverlay overlay;

        public Graphic(uz.myuzb.biometricfirst.GraphicOverlay overlay) {
